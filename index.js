...
function appear(){
	...
	var t = 500;
	for (const i in arr){
		setTimeout(() =>{images[arr[i]].style.visibility = 'visible';
...
function disappear(){
	for (const i in arr){
		images[arr[i]].style.visibility = 'hidden';
		console.log(i);
	}
}
...
images[0].addEventListener('click' ,(event) => {
	...
	if (images[0].classList.contains('target')){	
		console.log('RIGHT');
		answer.append(document.querySelector('.right_3'));
		...
		answer.append(document.querySelector('.wrong_3'));
...
images[4].addEventListener('click' ,(event) => {
	console.log(images[4]);
	if (images[4].classList.contains('target')){	
		console.log('RIGHT');
		answer.append(document.querySelector('.right_3'));
		document.querySelector('.right_3').style.visibility = 'visible';
...
images[5].addEventListener('click' ,(event) => {
	console.log(images[5]);
	if (images[5].classList.contains('target')){	
		console.log('RIGHT');
		answer.append(document.querySelector('.right_3'));
		document.querySelector('.right_3').style.visibility = 'visible';
